import {hex} from './endpoint.mjs?v=1549f29fdcdd6c2cf2bc';
  ...
  async reset({deferDevice=false}={}){
    ...
    try{
      ...
      for(const role of ['device','server']){
        const worker=this.workerFactory(new URL('./worker.mjs?v=1549f29fdcdd6c2cf2bc',import.meta.url));this.workers[role]=worker;
