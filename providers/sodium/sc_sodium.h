...
sc_status sc_sodium_seal(void *, sc_key_handle, const uint8_t peer[32], const uint8_t nonce[24],
                         const uint8_t *plain, size_t length, uint8_t *cipher, size_t capacity);
sc_status sc_sodium_open(void *, sc_key_handle, const uint8_t peer[32], const uint8_t nonce[24],
                         const uint8_t *cipher, size_t length, uint8_t *plain, size_t capacity);
...
sc_status sc_sodium_ed_seal(void *, sc_key_handle, const uint8_t[32], const uint8_t[24],
                            const uint8_t *, size_t, uint8_t *, size_t);
sc_status sc_sodium_ed_open(void *, sc_key_handle, const uint8_t[32], const uint8_t[24],
                            const uint8_t *, size_t, uint8_t *, size_t);
