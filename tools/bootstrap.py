...
def main():
    ...
    parser.add_argument('--verify-only', action='store_true', help='Verify cached archives and prerequisites without installation')
    ...
    for row in rows:
        ...
        if name.startswith('go'):
            ...
            with tempfile.TemporaryDirectory(dir=CACHE) as temporary:
                ...
                subprocess.run([str(component / 'install.sh'), '--prefix=' + str(CACHE / 'rust'), '--disable-ldconfig'], check=True, stdout=subprocess.DEVNULL)
